...
function updateWelcomeBox() {
  ...
  const content =
    ...
    `{center}{bold}{bright-cyan-fg}➥ FOLLOW TIKTOK : @Souiy1{/bright-cyan-fg}{/bold}{/center}\n` +
    `{center}{bold}{bright-cyan-fg}➥ Subscribe : Youtube.com/@souiybelang2524{/bright-cyan-fg}{/bold}{/center}\n` +
    `{center}{bold}{bright-yellow-fg}Donate : Satukan Solidaritas Bantu Palestina
...
safeRender();
mainMenu.focus();
addLog("Kendeq Lupaq Subscribe YT daet TIKTOK @Souiy1!!", "system");
updateWelcomeBox();
